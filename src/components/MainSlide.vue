    ...
    export default {
        ...
        data() {
            return {
                ...
                ButtonLoad : 'Load More',

                showSecondArray: false
            }
        },
        methods: {
           
            loadMore() {
                if (!this.showSecondArray) {
                // First click - show the second array
                this.imageContainer.push(...this.SecondImgageContainer);
                this.showSecondArray = true;
                this.ButtonLoad = 'Load Less';
                } else {
                // Second click - show the first array
                this.imageContainer.splice(12, 12);
                this.showSecondArray = false;
                this.ButtonLoad = 'Load More';
                // Scroll to the position of the first array
                const element = document.getElementById('firstArray');
                const offset = 150; // Adjust this value to position the scroll higher
...
<template>
    ...
    <!-- title currrent series -->
    <div class="title" id="firstArray">
    ...
    <div class="slide">
        <div class="slide-container">
            <div class="slide-container-item" v-for="(item, index) in imageContainer" :key="index">
        ...
        <div class="slide-button">
            <button @click="loadMore()">{{ ButtonLoad }}</button>
        </div>
    </div>
...
.slide-container-item img:hover {
    opacity: 0.5;
}
